...
namespace VortexInstaller {
  struct VortexInstallAppChild {
    ...
    VortexInstallAppChild(const std::function<void()> &foo, const bool &finished) : m_Foo(foo), m_Finished(finished) { };
  ...
  class VortexInstallAppWindow : public std::enable_shared_from_this<VortexInstallAppWindow> {
   public:
    ...
    static std::shared_ptr<VortexInstallAppWindow> Create(
